package com.hms.monolithic.repository;

import com.hms.monolithic.MonolithicApp;

import com.hms.monolithic.config.Constants;
import com.hms.monolithic.config.audit.AuditEventConverter;
import com.hms.monolithic.domain.PersistentAuditEvent;
...
import static com.hms.monolithic.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
