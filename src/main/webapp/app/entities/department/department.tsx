  ...
  return (
    <div>
      <h2 id="department-heading">
        <Translate contentKey="monolithicApp.department.home.title">Departments</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="monolithicApp.department.home.createLabel">Create new Department</Translate>
        </Link>
      </h2>
        ...
        {departmentList && departmentList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="monolithicApp.department.departmentName">Department Name</Translate>
                </th>
                <th>
                  <Translate contentKey="monolithicApp.department.location">Location</Translate>
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {departmentList.map((department, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{department.location ? <Link to={`location/${department.location.id}`}>{department.location.postalCode}</Link> : ''}</td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="monolithicApp.department.home.notFound">No Departments found</Translate>
            </div>
          )
        )}
      </div>
