  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="monolithicApp.jobHistory.home.createOrEditLabel">
            <Translate contentKey="monolithicApp.jobHistory.home.createOrEditLabel">Create or edit a JobHistory</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : jobHistoryEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="startDateLabel" for="job-history-startDate">
                  <Translate contentKey="monolithicApp.jobHistory.startDate">Start Date</Translate>
                </Label>
                <AvInput
              ...
              <AvGroup>
                <Label id="endDateLabel" for="job-history-endDate">
                  <Translate contentKey="monolithicApp.jobHistory.endDate">End Date</Translate>
                </Label>
                <AvInput
              ...
              <AvGroup>
                <Label id="languageLabel" for="job-history-language">
                  <Translate contentKey="monolithicApp.jobHistory.language">Language</Translate>
                </Label>
                <AvInput
                ...
                >
                  <option value="FRENCH">{translate('monolithicApp.Language.FRENCH')}</option>
                  <option value="ENGLISH">{translate('monolithicApp.Language.ENGLISH')}</option>
                  <option value="SPANISH">{translate('monolithicApp.Language.SPANISH')}</option>
                </AvInput>
              </AvGroup>
              <AvGroup>
                <Label for="job-history-job">
                  <Translate contentKey="monolithicApp.jobHistory.job">Job</Translate>
                </Label>
              ...
              <AvGroup>
                <Label for="job-history-department">
                  <Translate contentKey="monolithicApp.jobHistory.department">Department</Translate>
                </Label>
              ...
              <AvGroup>
                <Label for="job-history-employee">
                  <Translate contentKey="monolithicApp.jobHistory.employee">Employee</Translate>
                </Label>
