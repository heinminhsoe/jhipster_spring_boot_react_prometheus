  ...
  return (
    <div>
      <h2 id="location-heading">
        <Translate contentKey="monolithicApp.location.home.title">Locations</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="monolithicApp.location.home.createLabel">Create new Location</Translate>
        </Link>
      </h2>
        ...
        {locationList && locationList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="monolithicApp.location.streetAddress">Street Address</Translate>
                </th>
                <th>
                  <Translate contentKey="monolithicApp.location.postalCode">Postal Code</Translate>
                </th>
                <th>
                  <Translate contentKey="monolithicApp.location.city">City</Translate>
                </th>
                <th>
                  <Translate contentKey="monolithicApp.location.stateProvince">State Province</Translate>
                </th>
                <th>
                  <Translate contentKey="monolithicApp.location.country">Country</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="monolithicApp.location.home.notFound">No Locations found</Translate>
            </div>
          )
        )}
      </div>
