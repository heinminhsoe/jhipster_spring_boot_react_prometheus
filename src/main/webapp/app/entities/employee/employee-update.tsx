  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="monolithicApp.employee.home.createOrEditLabel">
            <Translate contentKey="monolithicApp.employee.home.createOrEditLabel">Create or edit a Employee</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : employeeEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="salaryLabel" for="employee-salary">
                  <Translate contentKey="monolithicApp.employee.salary">Salary</Translate>
                </Label>
              ...
              <AvGroup>
                <Label id="commissionPctLabel" for="employee-commissionPct">
                  <Translate contentKey="monolithicApp.employee.commissionPct">Commission Pct</Translate>
                </Label>
                <AvField id="employee-commissionPct" type="string" className="form-control" name="commissionPct" />
              </AvGroup>
              <AvGroup>
                <Label for="employee-manager">
                  <Translate contentKey="monolithicApp.employee.manager">Manager</Translate>
                </Label>
                <AvInput id="employee-manager" type="select" className="form-control" name="manager.id">
                  <option value="" key="0" />
                  {employees
                    ? employees.filter(e => employeeEntity && e.id !== employeeEntity.id).map(otherEntity => (
              ...
              <AvGroup>
                <Label for="employee-department">
                  <Translate contentKey="monolithicApp.employee.department">Department</Translate>
                </Label>
